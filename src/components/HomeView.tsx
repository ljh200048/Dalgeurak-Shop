...
export default function HomeView({ setView, setSelectedClassId }: HomeViewProps) {
  ...
  return (
    <div className="space-y-16 pb-16">
      ...
      {/* 5. Quick Mini Services Grid (Muji concept cards) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-rose-500/5 border border-rose-500/10 space-y-3">
            ...
            <button onClick={() => setView('faq')} className="text-xs font-bold text-rose-500 hover:underline flex items-center gap-1 pt-1">
              FAQ 및 단체예약 문의 <ArrowRight className="w-3 h-3" />
            </button>
          </div>
        </div>
      </section>
